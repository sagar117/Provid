...
// const { createOrg, addUserToOrg } = require('../controllers/org.controller');
...
// Create organization route (authenticated)
router.post('/create', authenticateJWT, createOrg);

// Add user to organization route (authenticated)
router.post('/add-user', authenticateJWT, addUserToOrg);
